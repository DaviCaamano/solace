...
export const RowZoneIcon = ({ moveType }: ZoneIconProps) => {
  switch (moveType) {
    case MoveNotePosition.aheadOf:
      return (
        <div className={'title-icon-container absolute flex justify-center items-center right-full w-7 h-7'}>
    ...
    case MoveNotePosition.childOf:
      return (
        <div
          className={'title-icon-container absolute flex justify-center items-center right-full w-7 h-7'}
          style={{ left: '-0.1875rem' }}
        >
